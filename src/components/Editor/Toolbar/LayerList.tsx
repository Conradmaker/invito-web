...
import {useLayer, EditableLayerName, Layers} from "@craftjs/layers";
import {useEditor} from "@craftjs/core";
import {LayerContainer} from "./styles";
import {LayerOptions} from "@craftjs/layers/lib/interfaces";
import styled from "styled-components";
import {LuArrowBigDown, LuEye, LuLink} from "react-icons/lu";
import {DefaultLayer} from "./Layer";
...
export const LayerHeader: LayerOptions["renderLayer"] = (el) => {
  const {
    id,
    depth,
    children,
