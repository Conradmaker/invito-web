    ...
    <main className="flex min-h-screen flex-col p-24 w-[100%]">
      ...
      <div className="flex justify-between w-full">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Input.Select size="xs" placeholder="XSmall 사이즈" />
          <Input.Select size="sm" placeholder="Small 사이즈" />
          <Input.Select size="md" placeholder="Medium 사이즈" />
          <Input.Select size="lg" placeholder="Large 사이즈" />
        </div>
      </div>
      {/* 라벨 */}
      <Typo.Heading level={2} mb={24} mt={80}>
